function sudoku_gui()
    ...
    img = uiimage(fig, 'Position', [0 260 408 179], 'ImageSource', 'logo.png');

    newGameButton = uibutton(fig, 'Position', [150 200 100 40], 'Text', 'Nowa gra','ButtonPushedFcn', @(btn,event)newGame());
    difficulty = uidropdown(fig,'Position', [150 150 100 40],"Items",["Łatwy","Średni","Trudny"]);
